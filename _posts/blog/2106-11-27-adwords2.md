...
With an r-squared of 0.0249166 we would want to visualize our data to confirm our assumptions. Our toy model here only explains 2.49% of the variation, so we may want to go back and look more at the outliers and build another model.
